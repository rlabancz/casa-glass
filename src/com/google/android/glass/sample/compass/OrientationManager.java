...
public class OrientationManager {
	...
	/**
	 * The maximum age of a location retrieved from the passive location provider before it is considered too old to use when the compass first starts
	 * up.
	 */
	private static final long MAX_LOCATION_AGE_MILLIS = TimeUnit.MINUTES.toMillis(30);

	/**
	 * The sensors used by the compass are mounted in the movable arm on Glass. Depending on how this arm is rotated, it may produce a displacement
	 * ranging anywhere from 0 to about 12 degrees. Since there is no way to know exactly how far the arm is rotated, we just split the difference.
	 */
	private static final int ARM_DISPLACEMENT_DEGREES = 6;

	/**
	 * Classes should implement this interface if they want to be notified of changes in the user's location, orientation, or the accuracy of the
	 * compass.
	 */
	...
	/**
	 * Starts tracking the user's location and orientation. After calling this method, any {@link OnChangedListener}s added to this object will be
