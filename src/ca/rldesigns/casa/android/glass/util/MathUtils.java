...
public class MathUtils {
	...
	/**
	 * Calculates {@code a mod b} in a way that respects negative values (for example, {@code mod(-1, 5) == 4}, rather than {@code -1}).
	 * 
	 * @param a
	 *            the dividend
	 * @param b
	...
	/**
	 * Converts the specified heading angle into an index between 0-15 that can be used to retrieve the direction name for that heading (known as
	 * "boxing the compass", down to the half-wind level).
	 * 
	 * @param heading
	 *            the heading angle
	 ...
	 * @return the relative bearing from point 1 to point 2, in degrees. The result is guaranteed to fall in the range 0-360
	 */
	...
	/**
	 * Gets the great circle distance in kilometers between two geographical points, using the <a
